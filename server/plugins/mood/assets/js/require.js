/*! sample-collector - v0.0.0 - 2015-12-13
...
define('../../assets/js/models/appViewModel.js',['jquery',
  ...
  return function () {
	...
	function post(feeling) {
		...
		$.post('http://localhost:8080/api/data', data, function(returnedData) {
       		self.done(true);
		});
	...
	self.powerless = function() {
		post('powerless');
	}; 
   self.depressive = function() {
		post('depressive');
	};
